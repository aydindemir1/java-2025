...
public class Company {
    ...
    public static void main(String[] args) {
        ...
        List <Product> productsList2 =  productsList1.stream()
                ...
                .limit(3)  // İlk 3 tanesi getir 
                .collect(Collectors.toList());  // Liste şeklinde al
             // .toList();
        ...
        List<Product> productsList3 = productsList1.stream()
                .filter(product -> product.getPrice() > 2 && product.getPrice() < 5)
                .limit(10)  // İlk 10 adet i getir
                .toList();  // Liste şeklinde al

        Double total = productsList3.stream()
                .mapToDouble(Product::getPrice)  // Product tan getPrice ları al.
                .sum();   // Toplamak
