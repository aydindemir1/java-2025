...
public class AppMain {
    ...
    public static void main(String[] args) {
        ...
        //List  <String>  myStudentList4 = List.of("Burhan", "Erhan", "Cuneyt", "Haluk", "Emrehan", "Emre", "Mahmut", "Mahmut");  // Buna sonradan add ile ekleme yapılamaz.Sebebi immutable olmasıdır.
        ...
        // Streamler tek kullanımlıktır!   => Sadece bir kez fonksiyon çağrısı yapılabilir ikinci ve daha sonra fonksiyon çağrısı yapılamaz ve yapılırsa program çalışma zamanında hata fırlatır.
       ...
       // myStudentsStream.forEach(System.out::println);
        myStudentsStream.forEach(ogrenci -> System.out.println(ogrenci));  // Lambda Expression 
