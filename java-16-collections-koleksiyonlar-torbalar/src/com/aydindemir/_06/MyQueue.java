...
public class MyQueue {
    ...
    public static void main(String[] args) {
    	...
    	System.out.println("----------  ArrayBlockingQueue   girdiğimiz sırada, null olmaz, duplicate olur  ------------");
       ...
       // studentList1.add(null); // Olmaz!!
        ...
        System.out.println("----------  PriorityQueue alfabetik sırada, null olmaz, duplicate olur   ------------");
