...
public class MySet {
    public static void main(String[] args) {
        System.out.println("--- HashSet rastgele, null olur, duplicate olmaz -------------");
        ...
        System.out.println("\n\n----TreeSet sıralı  ve null olmaz!!!, duplicate olmaz --------------");
      ...
      //  studentList4.add(null); // OLMAZ!!!
        ...
        System.out.println("\n\n---LinkedHashSet bizim girdigimiz sırada,null olur,  duplicate olmaz---------------");
